...
def load_best_model(embeddings):
    ...
    # Try best model file, then specific model
...
if __name__ == "__main__":
    ...
    if "moa" in valid_results:
        ...
        if moa["auc_delta"] > 0.02:
            print(f"\n  ✓ PAM recovers MOA better than L1000 cosine alone (+{moa['auc_delta']:.3f})")
